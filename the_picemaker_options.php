  ...
  <table class="form-table">
    ...
    <tr valign="top">
      ...
      <td><?php wp_dropdown_categories(array('show_option_none' => 'Select Category', 'name' => 'the_piecemaker[category]', 'selected' => $tpopts['category'])); ?>
        ...
        <p>You can either select one category here, or setup manual slideshow with 3<sup>rd</sup> and 4<sup>th</sup> options ( Image URL's and Image Descriptions respectively ).
          If you select category here, slideshow will be created using posts in that category. You have to add an extra
          custom field
          with name 'the_piecemaker_image' and absolute url of image as value.
    ...
    <tr valign="top">
      ...
      <td><textarea name="the_piecemaker[image_url]" style="width:100%"
        ...
        <p>Add list of absolute image URLs separated by line break. You must use absolute url and your image must be stored within your wordpress blog directory.</p>
      </td>
    </tr>
